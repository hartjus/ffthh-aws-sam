...
* Invoke the local functions, but you need a dynamodb docker instance: `docker run -p 8000:8000 amazon/dynamodb-local`
* Create the table: `aws dynamodb create-table --cli-input-json file://dynamodb/sample-table.json --endpoint-url http://localhost:8000`
* Invoke your function:
* * `sam local invoke "putItemFunction" -e events/event-post-item.json`
...
```bash
sam delete --stack-name ffthh-aws-sam-jhart
```
